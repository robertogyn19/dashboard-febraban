            ...
            () => {
                return {
                    ...
                    link: (scope, element, attrs) => {
                        ...
                        var url = "http://api.gogeo.io/1.0/map/" + Configuration.getDatabaseName() + "/" + Configuration.getCollectionName() +
                            "/{z}/{x}/{y}/tile.png?mapkey=" + Configuration.getMapKey() + "&stylename=gogeo_many_points";
